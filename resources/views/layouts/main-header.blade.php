							...
							<li class="nav-item dropdown">
								<a href="#" class="nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
									<span class="avatar country-Flag mr-0 align-self-center bg-transparent">
										<img src="{{URL::asset(session('locale') == 'ar' ? 'assets/img/flags/french_flag.jpg' : 'assets/img/flags/us_flag.jpg')}}" alt="flag">
									</span>
									<div class="my-auto">
								...
								<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
									<a href="{{ route('locale.setting', ['en']) }}" class="dropdown-item d-flex">
										<span class="avatar ml-3 align-self-center bg-transparent">
											<img src="{{URL::asset('assets/img/flags/us_flag.jpg')}}" alt="English">
										</span>
										<div class="d-flex">
											<span class="mt-2">English</span>
										</div>
									</a>
									<a href="{{ route('locale.setting', ['ar']) }}" class="dropdown-item d-flex">
										<span class="avatar ml-3 align-self-center bg-transparent">
											<img src="{{URL::asset('assets/img/flags/french_flag.jpg')}}" alt="العربية">
										</span>
										<div class="d-flex">
								...
								<div class="dropdown-menu">
									...
									<div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1 name">Petey Cru88iser</h5>
												</div>
